 ...
 *
 */
public class ApiForSolrDataHjy extends RootApiForManage<ApiForSearchSolrDataResult,ApiForSearchSolrDataInput>{
	...
	public ApiForSearchSolrDataResult Process(
		...
		try{
			...
			if(TopUp.upConfig("productcenter.jyhwebclient").equals("yes") || TopUp.upConfig("productcenter.hjywebclient").equals("yes")){
