 ...
 * 
 */
public class UpdateModProductForCa extends RootFunc {
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		try {
			if (mResult.upFlagTrue()) {
				...
				pp.setCostPrice(BigDecimal.valueOf(Double.valueOf(mSubDataMap.get("cost_price"))));
