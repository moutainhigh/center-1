 ...
 *
 */
public class PcSkuPriceUpdateCheckFuncDsf extends RootFunc {
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		int count = DbUp.upTable("sc_flow_main").count("outer_code",product_code,
				"flow_type",Constants.FLOW_TYPE_SKUPRICE_APPROVE,"current_status",Constants.FLOW_STATUS_SKUPRICE_YY);
