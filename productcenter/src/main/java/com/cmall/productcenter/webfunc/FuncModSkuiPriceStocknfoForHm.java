...
public class FuncModSkuiPriceStocknfoForHm extends RootFunc {
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		if(sys==null){
			...
			if(sys.getManageCode().equals(AppConst.MANAGE_CODE_CAPP)){
			 rootResult = service.changeProductSkuStock(info,AppConst.MANAGE_CODE_CAPP);	
			}else if (sys.getManageCode().equals(AppConst.MANAGE_CODE_CYOUNG)) {
			rootResult = service.changeProductSkuStock(info,AppConst.MANAGE_CODE_CYOUNG);	
			}
