...
public class PcProductinfo {
	 ...
	 * 商品属性list
	 */
	private List<PropertiesProductRelation> pprList = new ArrayList<PropertiesProductRelation>();
	 ...
	 * 5.3.0 LD商品支持多广告图
	 */
	private List<PcProductAdpic> pcAdpicList = new ArrayList<PcProductAdpic>();
	...
	/**
	 * 仅支持在线支付 449747110001:否，449747110002:是
	 */
	...
	public String getVideoUrlShow() {
		return videoUrlShow;
	}

	public void setVideoUrlShow(String videoUrlShow) {
		this.videoUrlShow = videoUrlShow;
	}
	...
	public List<PcProductAdpic> getPcAdpicList() {
		return pcAdpicList;
	}

	public void setPcAdpicList(List<PcProductAdpic> pcAdpicList) {
		this.pcAdpicList = pcAdpicList;
	}
	...
	public List<PropertiesProductRelation> getPprList() {
		return pprList;
	}

	public void setPprList(List<PropertiesProductRelation> pprList) {
