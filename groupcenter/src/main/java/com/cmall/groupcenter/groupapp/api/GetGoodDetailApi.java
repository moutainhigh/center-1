 ...
 * 
 */
public class GetGoodDetailApi extends RootApi<GetGoodsCricleListInfoResult, GetGoodsCricleListInfoInput>{ 
	...
	public GetGoodsCricleListInfoResult Process(GetGoodsCricleListInfoInput inputParam,
		...
		GetGoodsCricleListInfoResult result =gcService.generateGoodsCricleInfo(inputParam,null,null,null);
