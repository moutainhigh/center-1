 ...
 *推送广播消息、通知
 * */
public class IosPushBroadcastMessageSingle {

	/**
	 * 发送通知信息
	 * */
    public MWebResult sendNotifyMsg(String title,String comment,String params,String apiKey,String secretKey,int deployStatus,String userId) {
