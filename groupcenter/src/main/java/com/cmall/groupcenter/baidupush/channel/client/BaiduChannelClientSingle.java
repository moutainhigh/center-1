...
public class BaiduChannelClientSingle implements BaiduChannel {
    ...
    public BaiduChannelClientSingle(ChannelKeyPair pair) {
        this(pair, BaiduChannelConstants.CHANNEL_REST_URL);
    }

    private BaiduChannelClientSingle(ChannelKeyPair pair, String host) {
    ...
    public PushUnicastMessageResponse pushUnicastMessage(
            PushBroadcastMessageRequestSingle request) throws ChannelClientException,
