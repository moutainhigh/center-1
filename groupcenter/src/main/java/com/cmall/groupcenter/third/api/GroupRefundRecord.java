 ...
 *
 */
public class GroupRefundRecord extends RootApiForManage<WithdrawRecordResult, GroupAccountInfoInput>{
	...
	public WithdrawRecordResult Process(GroupAccountInfoInput inputParam,
		...
		if(accountCode!=null){
			...
			withdrawRecordResult=groupService.showRefundRecord(accountCode, withdrawRecordInput);
		}
