 ...
 *
 */
public class JobCountRebateOrderData  extends RootJob{

	@Override
	public void doExecute(JobExecutionContext context) {
		
		DbTemplate jdbcTemplate = DbUp.upTable("gc_count_rebate_data").upTemplate();
		...
		Map<String, Object> outValues = jdbcTemplate.getJdbcOperations().call(  
			       new CallableStatementCreator() {  
			            public CallableStatement createCallableStatement(Connection conn) throws SQLException {  
			              final String callFunctionSql = "{call p_count_rebate_data(?)}";
...
//
//		JobCountRebateOrderData job = new JobCountRebateOrderData();
//
//		job.doExecute(null);
//	}
}
