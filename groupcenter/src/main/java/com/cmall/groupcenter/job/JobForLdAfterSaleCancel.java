 ...
 *
 */
public class JobForLdAfterSaleCancel extends RootJob {
	@Transactional
	@Override
	public void doExecute(JobExecutionContext context) {
		 ...
		 */		
		String sql = "SELECT * FROM ordercenter.oc_after_sale_ld WHERE after_sale_status = '06' and if_post = '2' and after_sale_type = '1' LIMIT 0,2000";
		...
		for (Map<String, Object> map : list) {
			...
			postMap.put("ordId",
					Integer.parseInt(map.get("order_code").toString()));
			postMap.put(
					"ordSeq",
					Integer.parseInt(map.get("order_seq") != null ? map.get(
							"order_seq").toString() : "0"));
			postMap.put("goodId",
					Integer.parseInt(map.get("product_code").toString()));
		...
		String url = bConfig("groupcenter.rsync_homehas_url")+"syncAfterService";// TODO
		Date requestDate = new Date();
		String result = HttpUtil.post(url, JSONArray.toJSONString(postParams),
				"UTF-8");
