...
import com.cmall.newscenter.model.InforMationFeedInput;
import com.cmall.newscenter.model.InforMationFeedVideo;
import com.cmall.newscenter.model.InforMationFreedResult;
 ...
 * @version 1.0
 */
public class InforMationFeedApi extends RootApiForMember<InforMationFreedResult, InforMationFeedInput> {

	public InforMationFreedResult Process(InforMationFeedInput inputParam,
			MDataMap mRequestMap) {
		InforMationFreedResult result = new InforMationFreedResult();
		...
		mWhereMap.put("show_type", "4497464900010002");
