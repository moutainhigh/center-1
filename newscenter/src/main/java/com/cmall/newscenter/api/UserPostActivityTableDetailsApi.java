...
import com.cmall.newscenter.model.UserPostActivityTableDetailsInput;
import com.cmall.newscenter.model.UserPostActivityTableDetailsResult;
 ...
 * 活动详情
 * 
 * @author shiyz date 2014-10-21
 * @version 1.0
 */
public class UserPostActivityTableDetailsApi extends RootApiForMember<UserPostActivityTableDetailsResult, UserPostActivityTableDetailsInput> {

	public UserPostActivityTableDetailsResult Process(UserPostActivityTableDetailsInput inputParam, MDataMap mRequestMap) {
		
		
		UserPostActivityTableDetailsResult result = new UserPostActivityTableDetailsResult();
		       ...
		       if (result.upFlagTrue()) {
			    ...
			    if(mDataMap!=null){
					...
					count = DbUp.upTable("nc_registration").count("info_code",mDataMap.get("info_code"));
					
					
					activity.setApply_count(count);
