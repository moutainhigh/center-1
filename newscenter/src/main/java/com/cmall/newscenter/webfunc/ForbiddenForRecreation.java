...
public class ForbiddenForRecreation extends RootFunc{
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		if("449747170001".equals(recreationUse)){
			mResult.setResultCode(934205116);
			mResult.setResultMessage(bInfo(934205116));
			return mResult;
		}else{
			MDataMap whereDataMap  = new MDataMap();
			whereDataMap.put("recreation_use", "449747170001");
			whereDataMap.put("uid", tplUid);
				DbUp.upTable("nc_recreation").dataUpdate(whereDataMap, "recreation_use", "uid");
		}
