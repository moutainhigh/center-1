 ...
 * @version 1.0
 **/
public class DynamicReviewsLine extends RootFunc{
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		if (mResult.upFlagTrue()){
			...
			{//获得即将跳转到的状态id
				...
				buttonHtml+="<input type='button' style='margin-right:5px;' class='btn  btn-primary' zapweb_attr_operate_id='115793e80b35072vvsf5931e0qa508z9' zap_tostatus_attr='"+us.getToStatus()+"' value='"+buttonValue+"'>";	
			}
