 ...
 * 惠美丽商品分类
 */
public class FunProductCategoryAddHml extends RootFunc {
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		sellercategoryService.updateSellercategoryProductRelation(product_code, category_codes,UserFactory.INSTANCE.create().getManageCode());
