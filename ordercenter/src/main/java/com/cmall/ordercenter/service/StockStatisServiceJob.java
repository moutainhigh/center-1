 ...
 *
 */
public class StockStatisServiceJob  extends RootJob{
	...
	public String doStatis(){
		...
		DbTemplate jdbcTemplate = DbUp.upTable("pc_stock_warning").upTemplate();
		...
		Map<String, Object> outValues = jdbcTemplate.getJdbcOperations().call(  
			       new CallableStatementCreator() {  
			            public CallableStatement createCallableStatement(Connection conn) throws SQLException {  
			              final String callFunctionSql = "{call p_sku_warning(?)}";
