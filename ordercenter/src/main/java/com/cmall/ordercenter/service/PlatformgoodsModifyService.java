...
/**
 * 
 * 类名称：     PlatformgoodsModifyService 
 * 类描述：     增加换货状态日志
 * 创建人：     shiyz  
 * 创建时间：2014-07-03
 *
 */
public class PlatformgoodsModifyService implements IFlowFunc{
	...
	public RootResult afterFlowChange(String flowCode, String outCode,
		...
		PlatformgoodsStatusLogService egLogService = new PlatformgoodsStatusLogService();
