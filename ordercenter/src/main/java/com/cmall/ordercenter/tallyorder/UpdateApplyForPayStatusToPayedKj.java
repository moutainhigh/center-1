 ...
 *
 */
public class UpdateApplyForPayStatusToPayedKj extends RootFunc {
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		String sql = "select pay_code,settle_codes,merchant_code,pay_time from oc_bill_apply_payment_kj "
		...
		List<Map<String, Object>> list = DbUp.upTable("oc_bill_apply_payment_kj").dataSqlList(sql, new MDataMap());
		...
		sql = "update oc_bill_apply_payment_kj set flag='4497477900060007' "
				+ "where flag='4497477900060006' and is_pay='4497477900020001' and pay_time is not null";
		int count = DbUp.upTable("oc_bill_apply_payment_kj").dataExec(sql, mDataMap);
		...
		//变更商户结算单状态(已结算)
		try {
			sql = "select merchant_code,settle_codes from oc_bill_apply_payment_kj "
					+ "where flag='4497477900060007' and is_pay='4497477900020001' and pay_time is not null";
			List<Map<String, Object>> applyList = DbUp.upTable("oc_bill_apply_payment_kj").upTemplate().queryForList(sql, new MDataMap());
