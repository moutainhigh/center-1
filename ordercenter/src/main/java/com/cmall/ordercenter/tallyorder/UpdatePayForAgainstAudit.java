...
/** hw 16/4/1
 * 商户结算3.0-付款申请单反审核(将付款申请单状态改为待审核)
 ...
 * 拒绝     4497477900010005
 */
public class UpdatePayForAgainstAudit extends RootFunc{
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		DbUp.upTable("oc_bill_apply_payment").dataUpdate(new MDataMap("uid",uid,"flag","4497477900010001"),"flag", "uid");
		//记日志
		Date now = new Date();
