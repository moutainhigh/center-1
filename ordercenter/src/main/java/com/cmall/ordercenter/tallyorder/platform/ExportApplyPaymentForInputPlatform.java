 ...
 * @author zht
 */
public class ExportApplyPaymentForInputPlatform extends RootExport {
	...
	public void export(String sOperateId, HttpServletRequest request,
		...
		//只查询已确认的付款申请单
		String where = "";
		String sql = "select pay_code, merchant_code, merchant_name, actual_pay_amount, create_time, pay_time "
				+ "from oc_bill_apply_payment_pt a where a.flag= '4497477900060006' ";
...
//		FileOutputStream out = null;
		try {
			in = ExportApplyPaymentForInputPlatform.class
