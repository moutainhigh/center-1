...
/**
 * 
 * 类: UpdatePayForAuditStatusToConfirmKj <br>
 * 跨境相关-审核付款申请单-确认(将付款申请单状态改为已确认)<br>
 ...
 * 作者: zhy<br>
 * 时间: 2017年5月3日 下午4:12:05
 */
public class UpdatePayForAuditStatusToConfirmKj extends RootFunc {
