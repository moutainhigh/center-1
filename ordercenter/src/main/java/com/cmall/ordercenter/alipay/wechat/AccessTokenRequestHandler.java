...
import com.cmall.ordercenter.alipay.util.TokenValidityUtil;
...
public class AccessTokenRequestHandler extends RequestHandler {
	...
	/**
	 * 获取凭证access_token(已修改)
	 * @return
	 */
	public static String getAccessToken() {
		if ("".equals(access_token)) {// 如果为空直接获取
			TokenValidityUtil tokenValidityUtil = new TokenValidityUtil();
			return tokenValidityUtil.getTokenReal();
		}
