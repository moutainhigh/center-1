...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxb4964132ba624ffd";//微信开发平台应用id
	public static String APP_SECRET = "1629a47c071c01946439cfcb532f86c7";//应用对应的凭证
	//应用对应的密钥
	public static String APP_KEY = "hAOfmrH13RYzjJfgVq4ypTdyYqJxlEyEO6Axwd2mTDAbgpxwbdNR194YtqE52u5rI279qy5kcBG7gVZserVMFu2lPURay5I2oYgNULiCTYpQJgaU4QEoyBRtFh8shJRk";
	public static String PARTNER = "1224643701";//财付通商户号
	public static String PARTNER_KEY = "801a0a0f994249130b81cc0c2502ff1d";//商户号对应的密钥
