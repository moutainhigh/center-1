package com.cmall.membercenter.hxsupport.httpclient.vo;
...
public class ClientSecretCredential extends Credential {
	...
	public ClientSecretCredential(String clientID, String clientSecret, URL USERS_URL) {
		super(clientID, clientSecret);
		CLIENTSECRETCREDENTAIL_TOKEN_URL = USERS_URL;
	}
	...
	public Token getToken() {
		if (null == token || token.isExpired()) {
			try {
				...
				LOGGER.info("-----------------------------返回结果-------------------------------statuscode:" + tokenResponse.getStatusLine().toString());
