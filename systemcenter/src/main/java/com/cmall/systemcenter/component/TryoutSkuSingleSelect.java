 ...
 *
 */
public class TryoutSkuSingleSelect extends ComponentWindowSingle {
	...
	public String upText(MWebField mWebField, MDataMap mDataMap, int iType) {
		...
		mWebField.setSourceParam("zw_s_max_select=1&zw_s_source_tableinfo=pc_skuinfo|sku_code|sku_name&zw_s_source_page=page_chart_v_single_pc_skuinfo");
