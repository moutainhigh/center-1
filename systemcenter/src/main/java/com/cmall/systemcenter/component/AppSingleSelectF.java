 ...
 *
 */
public class AppSingleSelectF extends ComponentWindowSingle {
	...
	public String upText(MWebField mWebField, MDataMap mDataMap, int iType) {
		...
		mWebField.setSourceParam("zw_s_max_select=1&zw_s_source_tableinfo=uc_appinfo|app_code|app_name&zw_s_source_page=page_chart_vv_uc_appinfo");
