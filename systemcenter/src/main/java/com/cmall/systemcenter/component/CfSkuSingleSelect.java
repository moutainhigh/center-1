...
public class CfSkuSingleSelect extends ComponentWindowSingle{
	...
	public String upText(MWebField mWebField, MDataMap mDataMap, int iType) {
		...
		mWebField.setSourceParam("zw_s_max_select=1&zw_s_source_tableinfo=pc_skuinfo|sku_code|sku_name&zw_s_source_page=page_chart_v_pc_skuinfo_comment_cf");
...
//	 * 惠家有 显示 sku名称
//	 */
//	public String upShowCfPost(MWebField mWebField, MDataMap mDataMap,
//			int iType) {
//
