...
public class JedisLock extends BaseClass{
	...
	/*******锁状态标志*********/ 
//	private ShardedJedisPool shardedJedisPool;(使用redis集群时配置启用)
//	private ShardedJedis jedis;
	...
	public JedisLock(String key) {
		this.key = key + "_lock";
		this.shardedJedisPool =  new JedisPool(new JedisPoolConfig(), (new jedisUtil()).getHost());
		this.jedis = this.shardedJedisPool.getResource();
		jedis.auth((new jedisUtil()).getPwd());
	}
